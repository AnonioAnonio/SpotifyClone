...
function handleOrientation(event) {
    ...
    document.getElementById("alpha").innerHTML="<h3>alpha: "+x+"</h3>";
    document.getElementById("beta").innerHTML="<h3>beta: "+y+"</h3>";
    document.getElementById("gamma").innerHTML="<h3>gamma: "+z+"</h3>";
